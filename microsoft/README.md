...
to set up your environment. The [default configuration file](.config/configuration.winget) installs Visual Studio Community and the rest of the required tools. There are two other variants of the configuration file available in the [.config](.config) directory for Enterprise & Professional editions. To run the default configuration file, you can either double-click the file from explorer or run the following command:
...
* You must have the [Windows 11 (10.0.22621.0)
  ...
  installed
* You must have [Visual Studio](https://visualstudio.microsoft.com/downloads/) installed
* You must install the following Workloads via the VS Installer. Note: Opening
  the solution in Visual Studio will [prompt you to install missing components
  ...
  * **The following Individual Components**
    * C++ Universal Windows Platform Tools that match your installed Visual Studio major version (`v145` for VS 2026, `v143` for VS 2022)
