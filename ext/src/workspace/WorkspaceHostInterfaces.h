...
namespace terminal::workspace
{
    ...
    public:
        ...
        virtual std::unordered_map<std::wstring, winrt::TerminalApp::implementation::TerminalCaptureState>& WorkspaceChatTerminalStates() = 0;
        virtual const std::unordered_map<std::wstring, winrt::TerminalApp::implementation::TerminalCaptureState>& WorkspaceChatTerminalStates() const = 0;
        virtual std::vector<winrt::TerminalApp::implementation::PendingTerminalOutputCapture>& WorkspaceChatPendingOutputCaptures() = 0;
        virtual const std::vector<winrt::TerminalApp::implementation::PendingTerminalOutputCapture>& WorkspaceChatPendingOutputCaptures() const = 0;
